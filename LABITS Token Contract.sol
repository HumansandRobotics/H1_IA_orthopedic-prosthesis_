...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "LABITS";
    string internal constant SYMBOL = "BITS";
    ...
    uint256 public constant maxTransactionAmount = TOTAL_SUPPLY / 100; // 1% of the total supply
    ...
    address public marketingAddress = 0x4b23288D1df4e4FCE1e5F839fFd33708BA8E5e41; //Marketing Address
    address public developingAddress = 0xcEa32b7AB80d0D2e3cE9D6E6D17ffeA3dE37E992; //Developing Address
    address public charityAddress = 0x550b5d7DC82d09bc02D2a01af7FA9479F14BEE62; //Charity Address
    address public teamAddress = 0x574f4A12D71BF97f66588608c5e8738b5B46E738; //Team Address

    address public burnAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public feeRedistribution = 1; //Redistribution Fee 1%
    ...
    uint256 public feeTeamDev = 1; //Team Fee 1%
